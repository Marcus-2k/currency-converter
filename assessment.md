...
- This should be done using the front-end framework of your choice.
- Please focus on component composition and adhering to best practices in coding first and foremost and then the overall layout and design.
